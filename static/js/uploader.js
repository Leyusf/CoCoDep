    ...
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            options = $.extend({
                ...
                dropZone: $(this),
                fileTypeWhiteList: ['jpg', 'png', 'jpeg', 'gif', 'pdf', 'docx', 'doc', 'pdf', 'pptx'],
            ...
            var dom = {
                uploaderBox: $(this),
                submitButton: $('<button id="uploadD" class="js-uploader__submit-button uploader__submit-button uploader__hide">' +
                    ...
                    $.ajax({
                        ...
                        xhr: function() {
                            ...
                            xhr.upload.addEventListener('progress', function (e) {
                                ...
                                //通过设置进度条的宽度达到效果
                                $("#uploadD").html("UPLOAD("+progressRate+")")
                        ...
                        success: function (data) {
                            if (data['code']==0){
                                $("#uploadD").html("Success")
                                $("#uploadD").attr('disabled',"disabled")
                                top.location.href='/module/'
                            }
                            else{
                                $("#uploadD").html("Failed")
                            }
